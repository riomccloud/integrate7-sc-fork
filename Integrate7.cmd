...
:skipRemoveDefender
 ...
 reg add "HKLM\TK_SYSTEM\ControlSet001\Control\CrashControl" /v CrashDumpEnabled /t REG_DWORD /d 3 /f >nul
 reg add "HKLM\TK_SYSTEM\ControlSet001\Control\CrashControl" /v SendAlert /t REG_DWORD /d 0 /f >nul

 reg add "HKLM\TK_SYSTEM\ControlSet002\Control\CrashControl" /v CrashDumpEnabled /t REG_DWORD /d 3 /f >nul
 reg add "HKLM\TK_SYSTEM\ControlSet002\Control\CrashControl" /v SendAlert /t REG_DWORD /d 0 /f >nul

 reg add "HKLM\TK_SYSTEM\ControlSet001\Control\Session Manager" /v AutoChkTimeOut /t REG_DWORD /d 0 /f >nul
 reg add "HKLM\TK_SYSTEM\ControlSet002\Control\Session Manager" /v AutoChkTimeOut /t REG_DWORD /d 0 /f >nul
 ...
 reg add "HKLM\TK_NTUSER\Software\Microsoft\Internet Explorer\Main" /v "Search Page" /t REG_SZ /d "https://lite.duckduckgo.com/" /f >nul
 ...
 reg add "HKLM\TK_SOFTWARE\Microsoft\Internet Explorer\Main" /v "Search Page" /t REG_SZ /d "https://lite.duckduckgo.com/" /f >nul
 reg add "HKLM\TK_SOFTWARE\Microsoft\Internet Explorer\Main" /v "Default_Page_URL" /t REG_SZ /d "about:blank" /f >nul
 reg add "HKLM\TK_SOFTWARE\Microsoft\Internet Explorer\Main" /v "Default_Search_URL" /t REG_SZ /d "https://lite.duckduckgo.com/" /f >nul
 ...
 REM Replace Bing with DuckDuckGo Lite
 ...
 reg add "HKLM\TK_SOFTWARE\Microsoft\Internet Explorer\SearchScopes\{0BBF48E6-FF9D-4FAA-AA4D-BDBB423B2BE1}" /v "DisplayName" /t REG_SZ /d "DuckDuckGo Lite" /f >nul
 reg add "HKLM\TK_SOFTWARE\Microsoft\Internet Explorer\SearchScopes\{0BBF48E6-FF9D-4FAA-AA4D-BDBB423B2BE1}" /v "URL" /t REG_SZ /d "https://lite.duckduckgo.com/lite/?q={searchTerms}" /f >nul
 ...
 reg add "HKLM\TK_SOFTWARE\Microsoft\Internet Explorer\SearchScopes\{0BBF48E6-FF9D-4FAA-AA4D-BDBB423B2BE1}" /v "SuggestionsURL_JSON" /t REG_SZ /d "https://api.duckduckgo.com/?q={searchTerms}&format=json" /f >nul
